# CSC500 - module 6 portfolio milestone - Joe Armani
from CSC500_module_4_online_shopping_cart_part_1 import enter_item, get_item_name, get_item_description, get_item_price, get_item_quantity
# step 4: Build the Shopping Cart class
class ShoppingCart:
