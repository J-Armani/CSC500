# CSC500 - module 6 portfolio milestone, Part 2 - Joe Armani
...
# Parts 2 and 3 commented out: These are from part 1 of the assignment, but requirements are different for part 2. They're not currently in use.
# def main():
